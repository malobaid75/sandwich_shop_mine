      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            // Display total price calculated from PricingRepository
            Text(
              'Total: ${_pricingRepository.formattedTotal(quantity: _orderRepository.quantity, isFootlong: _isFootlong)}',
              style: normalText,
            ),
